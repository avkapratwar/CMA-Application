			...
			<div class="row">
				<div class="main_header_row">
					<div class="col-md-3 col-xs-12">
						<!---------- Start Logo ------->
						<a href="#" class="logo"> <img src="images/hyd.jpg"
							alt="Kisaan eMithra">
						</a>
						<!------------ End of logo-------->
					</div>
					...
					<div class="buttons">
						...
						<div class="row">
							...
							<div class="col-md-4 col-md-12">
								...
								<a tabindex="-1" href="AddCourses.html">Add Courses</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a tabindex="-1" href="ShowAllCoursesServlet">Update Courses</a><br />
								<br />
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-xs-12">
						...
						<a href="#"><img src="images/hyd.jpg"></a>
