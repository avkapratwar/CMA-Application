...
<a href="ApplicationForm.html"><img src="resources/images/admission.png" style="width:250px;height:170px;" alt="registration open"></a><img src="resources/images/leftpoint.gif" style="width:50px;height:50px;" alt="vb"></a>click here<br/><br/>
</div>
<hr>
<div class="navbar">
...
<div class="container">
<center>
<h1>Check Status Of Application</h1><br/>
<hr>

</center>
</div>
<div class="container">
<form align="center" method="post" action="appstatus">
<div class="form-group row" >
<div col="col-xs-2">
<label for="usr">Application Number:</label>
<input type="text" class="form-control" name="ApplicationNumber" required="true" style="align="center";width:140px;height:40px;"/><br/>
