...
<a href="ApplicationForm.jsp"><img src="resources/images/admission.png" style="width:250px;height:170px;" alt="registration open"></a><img src="resources/images/leftpoint.gif" style="width:50px;height:50px;" alt="vb"></a>click here<br/><br/>
</div>
<hr>
<div class="navbar">
...
<div class="container">
<center>
<h1>Check Status Of Login Credentials</h1><br/>
<hr>

</center>
</div>
<div class="container">
<form align="center" method="post" action="searchstatus">
<center>
<div class="form-group row" >
<div col="col-xs-2">

<div class="form-group">
<label for="Usr" class="required width_100">RollNumber</label>
<div class="input-group">
<span class="form_icon_bg input-group-addon"><i
class="fa fa-user form_icon"></i></span> <input type="text"
id="UserName" name="rollnumber" placeholder="Rollnumber"
...
<div class="form-group">
<label for="usr">Select list (select one):</label> <select
