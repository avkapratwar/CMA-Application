					...
					<div class="buttons">
						...
						<div class="row">
							...
							<div class="col-md-4 col-md-12">
								...
								<a tabindex="-1" href="Courses.html">Courses</a><br />
								<br /> <a tabindex="-1" href="ClassSchedule.html">ClassSchedule</a><br />
								<br /> <a tabindex="-1" href="ExamSchedule.html">ExamSchedule</a>
								
							</div>
							<!-------------[col]------------>

							<div class="col-md-4 col-md-12">
								<a tabindex="-1" href="Events.html">Events</a><br />
								<br /> <a tabindex="-1" href="ShowPlacement.jsp">PlacementCalendar</a><br />
								<br /> <a tabindex="-1" href="ShowAllAlumniController">AlumniList</a>

							</div>
							<div class="col-md-4 col-md-12">
								<a tabindex="-1" href="StaffMeetings.html">StaffMeetings</a><br />
								<br /> <a tabindex="-1" href="ShowAllApplicantsController">AdmissionStatus</a><br />
								<br /> <a tabindex="-1" href="AddUser.jsp">Add Users</a> <a
									tabindex="-1" href="Logout.html">Logout</a><br />
								<br />
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-xs-12">
						...
						<a href="#"><img src="images/hyd.jpg"style="width:500px;height:170px;"></a>
