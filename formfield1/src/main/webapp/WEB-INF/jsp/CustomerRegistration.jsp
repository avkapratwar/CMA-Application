...
<body>
	<div>
		...
		<a href="ApplicationForm.html"><img src="images/admission.png"
			style="width: 250px; height: 170px;" alt="registration open"></a><img
			src="images/leftpoint.gif" style="width: 50px; height: 50px;"
			alt="vb"></a>click here<br />
		<br />
	</div>
	<hr>
	<div class="navbar">
		<a href="indexpage.html">Home</a> <a href="UohAboutus.html">Aboutus</a>
		<a href="News.html">News</a> <a href="Academics.html">Academics</a> <a
			href="NewsLetter.html">NewsLetter</a> <a href="AntiRagging.html">AntiRagging</a>
		<a href="Applicationstatus.html">Applicationstatus</a> <a
			href="LoginStatus.html">Loginstatus</a> <a href="MainLogin.html">Login</a>
	</div>
	<center>
		<b><h3>Application For University of Hyderabad</h3></b>
	</center>
	<hr>
	<form method="get" action="ApplicantController">
		...
		<center>
			...
			<div class="input-group">
				<label>Contact Number*</label> <input type="number" name="contact"
					required />
			</div>
			<div>
			...
			<div class="input-group">
				<label>10th percentage*</label> <input type="number"
					name="xprecentage" required />
			</div>
			<div class="input-group">
				<label>12th Percentage*</label> <input type="number"
					name="xiiprecentage" required />
			</div>
			<div class="input-group">
	...
	<div class="lates">
		...
		<div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms"
			...
			<img src="images/LIB.jpeg" class="img-responsive"><br />
			<br />
			<br />
		...
		<div class="col-md-4">
			...
			<img src="images/ctc offered ug.jpg" class="img-responsive">
